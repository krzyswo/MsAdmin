<#
=============================================================================================
Name:           Export App Registrations, Certificates, and Secrets
...
https://github.com/krzyswo/MsAdmin
...
Get-MgApplication -All -Property $RequiredProperties | foreach {
 ...
 Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/krzyswo/MsAdmin" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1800+ Microsoft 365 reports. ~~" -ForegroundColor Green `n
