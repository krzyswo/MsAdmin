...
$results | Export-Csv -Path "C:\Users\PLACEHOLDER\ResourceMailboxSettings.csv" -NoTypeInformation -Encoding UTF8

Write-Output "Report generated at C:\Users\PLACEHOLDER\Desktop\ResourceMailboxSettings.csv"
