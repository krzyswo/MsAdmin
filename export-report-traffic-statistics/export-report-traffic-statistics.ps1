...
While($true)
{
 ...
 Try
 {
  ...
  {
   Write-Host `
Mail traffic can be retrieved only for past 90 days. Please select a date after $MaxStartDate -ForegroundColor Red
   return
  }
 }
 Catch
...
While($True)
{
 ...
 { 
  Write-Progress -Activity "`
     Retrieving mail traffic data for $CurrentStart"
