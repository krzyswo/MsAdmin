<#
=============================================================================================
Name:           Room Mailbox Usage Report
Description:    This script provides detailed information on the usage of Office 365 room mailboxes
Version:        3.0
Website:        https://github.com/krzyswo/MsAdmin

Script Highlights:
~~~~~~~~~~~~~~~~~~
1.Automatically installs the MS Graph PowerShell module upon your confirmation when it is not available on your machine. 2.Also, you can execute this script with certificate-based authentication (CBA). 3.You can execute the script with an MFA-enabled account too. 4.Helps to filter details about online meetings alone.
