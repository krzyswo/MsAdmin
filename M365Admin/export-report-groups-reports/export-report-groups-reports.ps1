<#
=============================================================================================
Name:           Export Nested Groups Reports in Microsoft 365 Using PowerShell
Version:        1.0
...
if((Test-Path -Path $DetailedReport) -eq "True" -and (Test-Path -Path $SummaryReport) -eq "True") {
    ...
    Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/krzyswo/MsAdmin" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1900+ Microsoft 365 reports. ~~" -ForegroundColor Green
