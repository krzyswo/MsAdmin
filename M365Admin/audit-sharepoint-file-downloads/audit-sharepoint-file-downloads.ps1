<#
=============================================================================================
Name:           Audit SharePoint File Downloads using PowerShell
Version:        1.0
...
Write-Host `
Retrieving file download audit log from $StartDate to $EndDate... -ForegroundColor Yellow
$i=0
$ExportResult=""   
$ExportResults=@()  
...
{ 
 ...
 Write-Progress -Activity "`
     Retrieving file download audit data from $StartDate to $EndDate.."`
...
{
 Write-Host `
The exported report contains $OutputEvents audit records
