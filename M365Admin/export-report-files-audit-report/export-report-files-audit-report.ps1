<#
=============================================================================================
Name:           Export Deleted Files Audit Report
Description:    This script exports deleted files audit records to CSV using Exchange Online
=============================================================================================
#>
Param
(
...
else
{
 ...
 if((Test-Path -Path $OutputCSV) -eq "True") 
 {
  ...
  Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/krzyswo/MsAdmin" -ForegroundColor Yellow -NoNewline; 
