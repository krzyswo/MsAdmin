<#
=============================================================================================
Name:           Export App Registrations Expiry Report
Description:    This script retrieves and exports the expiration dates of app registrations' client secrets and certificates in Microsoft 365.
Version:        1.0
Website:        https://github.com/krzyswo/MsAdmin

Script Highlights:
1. Automatically verifies and installs the Microsoft Graph PowerShell SDK module upon confirmation.
2. Exports all app registrations with expiring client secrets and certificates into a CSV file.
3. Supports certificate-based authentication (CBA).
4. Scheduler-friendly.

For detailed script execution, visit the GitHub repository.
=============================================================================================
#>
...
Get-MgBetaApplication -All -Property $RequiredProperties | foreach {
 ...
 Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/krzyswo/MsAdmin" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1800+ Microsoft 365 reports. ~~" -ForegroundColor Green `n`n
