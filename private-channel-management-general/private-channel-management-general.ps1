...
Version:        2.0
Script by:      https://github.com/krzyswo/MsAdmin

To run the script
./private-channel-management.ps1

To schedule/run the script by explicitly mentioning credential
./private-channel-management.ps1 -UserName <UserName> -Password <Password>

To run the script with certificate based authentication
./private-channel-management.ps1 -TenantId <TenantId> -AppId <AppId> -CertificateThumbPrint <CertThumbPrint>

To run a specific action directly
./private-channel-management.ps1 -Action 7
 ...
 Switch ($i) {
  ...
  6 {
   ...
   9{
     ...
     Write-Progress -Activity "`n     Processed Private Channel count: $Count "`n"  Currently Processing: $Private Channel" -Completed
   Open_Output
    }    
