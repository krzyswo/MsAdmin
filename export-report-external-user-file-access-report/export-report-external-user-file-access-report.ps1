<#
=============================================================================================
Name:           SharePoint Online external user file access report
...
else
{
 ...
 if((Test-Path -Path $OutputCSV) -eq "True") 
 {
  ...
  Write-Host `n~~ Script prepared by MsAdmin Community ~~`n -ForegroundColor Green
