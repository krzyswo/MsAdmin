...
Write-Host `
Retrieving group membership changes audit log from $StartDate to $EndDate... -ForegroundColor Yellow
$i=0
$OutputEvents=0
$ExportResult=""   
$ExportResults=@()  
...
{ 
 ...
 if($CurrentResultCount -ge 50000)
 {
  ...
  $Confirm=Read-Host `n"Are you sure you want to continue? [Y] Yes [N] No"
  if($Confirm -match "[Y]")
  {
