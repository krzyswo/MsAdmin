<#
=========================================================================================
Name:           Reset Phone MFA Methods for Microsoft 365 Users
Version:        1.0
...
2. The script covers 7+ use cases to reset Phone MFA for Microsoft 365 users more granularly.
3. Users scope
       - Single user
       ...
       - Licensed users
       - Disabled users
4. This scripts supports resetting all types of Phone MFA (primary mobile, alternate mobile and Office phone).    
5. Exports log file.
