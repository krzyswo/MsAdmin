<#
=============================================================================================
Name:           Audit Shared Mailbox Email Sender
Description:    This script audits who sent emails from a shared mailbox, allowing for detailed tracking and reporting.
Version:        3.0
