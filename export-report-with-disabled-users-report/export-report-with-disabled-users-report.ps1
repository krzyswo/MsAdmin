<#
=============================================================================================
Name:           Export Groups with Disabled Users Report in Microsoft 365 using PowerShell 
Version:        1.0
...
$CSVFilePath = "$(Get-Location)\GroupsWithDisabledUsers_$(Get-Date -format yyyy-MMM-dd-ddd` hh-mm-ss` tt).csv"
...
Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "https://github.com/krzyswo/MsAdmin" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1900+ Microsoft 365 reports. ~~" -ForegroundColor Green `n
